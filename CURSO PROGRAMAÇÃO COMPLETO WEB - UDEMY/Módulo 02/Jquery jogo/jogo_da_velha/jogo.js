...
$(document).ready(function(){
	...
	$('#btn_inicar_jogo').click( function(){
		...
		//controle visualização das divs principais
		$('#pagina_inicial').hide();
		$('#palco_jogo').show();
	...
	function jogada(id){
		...
		//split é a função do JS que trunca uma cadeia de caracteres transformando a informação em array
	...
	function ganhador(pontos){
		if(pontos == -3){
			...
			$('.jogada').off(); // a função off remove a possibilidade de capturar o evento do click
		} else if(pontos == 3){
